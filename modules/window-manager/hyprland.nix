  ...
  config = lib.mkIf cfg {
    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        windowrule = [
          "opacity 0.9 0.6, class:^(Rofi)$"
          "opacity 0.9 0.7, class:^(Brave-browser(-beta|-dev)?)$"
          "opacity 0.9 0.7, class:^(Zen|Firefox|org.mozilla.firefox|Firefox-esr)$"
          "opacity 0.9 0.6, class:^(Thorium-browser)$"
          "opacity 0.9 0.8, class:^(Microsoft-edge(-stable|-beta|-dev|-unstable)?)$"
          "opacity 0.9 0.8, class:^(google-chrome(-beta|-dev|-unstable)?)$"
          "opacity 0.94 0.86, class:^(chrome-.+-Default)$"
          "opacity 0.9 0.8, class:^(Thunar|org.gnome.Nautilus)$"
          ...
          "opacity 0.9 0.7, class:^(Audacious)$"
          "opacity 0.9 0.8, class:^(VSCode|code-url-handler)$"
          "opacity 0.9 0.8, class:^(jetbrains-.+)$"
          "opacity 0.94 0.86, class:^(Cider)$"
          "opacity 0.94 0.86, class:^(Slack)$"
          "opacity 0.94 0.86, class:^(Revolt-desktop)$"
          "opacity 0.94 0.86, title:^(Discord|Vesktop)$"
          "opacity 0.9 0.8, class:^(Element)$"
          ...
          "opacity 0.9 0.7, class:^(Whatsapp-for-linux)$"
          "opacity 0.9 0.7, class:^(Ferdium)$"
